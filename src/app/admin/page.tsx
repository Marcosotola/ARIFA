...
const MODULES = [
  ...
  },
  {
    icon: "📋",
    label: "Planillas",
    description: "Órdenes de trabajo, detección, extinción y matafuegos.",
    href: "/admin/planillas",
    color: "#2b6cb0",
    roles: ["admin", "tecnico", "superadmin", "secretaria", "cliente"],
    clientLabel: "Mis Planillas",
    clientDescription: "Planillas e inspecciones de tus instalaciones.",
  },
  {
    icon: "🧯",
    label: "Matafuegos",
    description: "Remitos y mantenimiento de matafuegos.",
