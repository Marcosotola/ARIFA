        ...
        >
          <div
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLDivElement).style.boxShadow = "0 8px 30px rgba(13,149,136,0.12)";
            }}
            onMouseLeave={e => {
          ...
          >
            <div style={{
              ...
              background: "rgba(13,149,136,0.1)", display: "flex",
              alignItems: "center", justifyContent: "center", flexShrink: 0,
            }}>
              <FileText size={26} color="#0d9488" strokeWidth={2} />
            </div>
            <div style={{ flex: 1 }}>
