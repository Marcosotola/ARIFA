// Sugerencias iniciales para el campo Marca (que es de texto libre).
export const MARCAS_DISPONIBLES = ["MELISAM", "HORIZONTE", "DRAGO", "YUKON", "CASSARO", "FADESA", "CENTURION", "GEORGIA"];
